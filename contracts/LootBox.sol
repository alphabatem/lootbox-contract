...
contract LootBox is ERC1155Tradable, ReentrancyGuard {
    ...
    function addOption(
        ...
        LootBoxRandomness.addOption(state, _option, _maxQuantityPerOpen, _classStartId, _classCount, _classProbabilities, _uncommonItems, _rareItems, _epicItems, _guarantees);
    }
